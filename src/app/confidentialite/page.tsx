...
export default function Confidentialite() {
  return (
    <PageShell title="Politique de confidentialité">
      ...
      <section>
        <h2 className="font-cinzel text-xl text-[var(--color-text-primary)] mb-3">1. Données collectées</h2>
        <p>
      ...
      <section>
        <h2 className="font-cinzel text-xl text-[var(--color-text-primary)] mb-3">2. Services tiers</h2>
      ...
      <section>
        <h2 className="font-cinzel text-xl text-[var(--color-text-primary)] mb-3">3. Cookies</h2>
        <p>
      ...
      <section>
        <h2 className="font-cinzel text-xl text-[var(--color-text-primary)] mb-3">4. Liens de partage</h2>
        <p>
      ...
      <section>
        <h2 className="font-cinzel text-xl text-[var(--color-text-primary)] mb-3">5. Vos droits</h2>
        <p>
      ...
      <section>
        <h2 className="font-cinzel text-xl text-[var(--color-text-primary)] mb-3">6. Conformité</h2>
        <p>

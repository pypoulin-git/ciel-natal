  ...
  return (
    <PageShell title={fr ? "Politique de confidentialité" : "Privacy Policy"}>
      ...
      <section>
        ...
        <p>
          {fr
            ? <>Natalune est un outil d&apos;astrologie psychologique opéré par <strong className="text-[var(--color-text-primary)]">Pier-Yves Poulin</strong>, basé au Québec (Canada). Pour toute question relative à tes données ou pour exercer tes droits (accès, suppression, portabilité), écris-nous via la <a href="/contact" className="text-[var(--color-accent-lavender)] hover:underline">page Contact</a>. Le responsable de la protection des renseignements personnels (équivalent du « DPO » au Québec) est PY Poulin lui-même, joignable à la même adresse.</>
            : <>Natalune is a psychological astrology tool operated by <strong className="text-[var(--color-text-primary)]">Pier-Yves Poulin</strong>, based in Quebec, Canada. For any question regarding your data or to exercise your rights (access, deletion, portability), reach us via the <a href="/contact" className="text-[var(--color-accent-lavender)] hover:underline">Contact page</a>. The privacy officer (Quebec equivalent of a DPO) is PY Poulin himself, reachable at the same address.</>}
        </p>
      </section>

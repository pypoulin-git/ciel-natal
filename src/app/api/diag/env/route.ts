...
export async function GET(req: NextRequest) {
  ...
  const expected: Array<{ name: string; feature: string; required: boolean }> = [
    ...
    { name: "GOOGLE_GENERATIVE_AI_API_KEY", feature: "Gemini — chat IA + interpretations + TTS (repli)", required: true },
    { name: "XAI_API_KEY", feature: "Grok TTS — lecture audio premium (provider principal)", required: false },
